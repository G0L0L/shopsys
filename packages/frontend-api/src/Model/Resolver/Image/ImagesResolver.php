...
{
    protected const IMAGE_PRODUCT_ENTITY = 'product';
    protected const IMAGE_CATEGORY_ENTITY = 'category';
    ...
    {
        return $this->resolveByEntity($product, static::IMAGE_PRODUCT_ENTITY, $type, $size);
    }
    ...
    {
        return $this->resolveByEntity($category, static::IMAGE_CATEGORY_ENTITY, $type, $size);
    }
     ...
     */
    protected function getSizeConfigs(?string $type, ?string $size, string $entityName)
    {
